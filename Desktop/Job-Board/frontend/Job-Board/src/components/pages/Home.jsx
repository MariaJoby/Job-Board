            ...
            {[
              {
                ...
                desc: 'Only real and trusted employers.',
              },
              {
                title: 'Easy Job Matching',
                desc: 'Personalized job recommendations for you.',
              },
              {
                title: 'Resume Upload',
                desc: 'Apply with one click using your resume.',
              },
            ].map((feature, index) => (
            ...
            {[
              {
                ...
                desc: 'Register in seconds with your email.',
              },
              {
                step: '2. Log In',
                desc: 'Access thousands of verified job listings.',
              },
              {
                step: '3. Apply',
                desc: 'Find the right job and apply easily.',
              },
            ].map((item, index) => (
              <Grid item xs={12} md={4} key={index}>
                <Paper
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Box sx={{ flex: 1, minWidth: 200 }}>
              ...
              <Typography variant="body1">
                JobConnect helps job seekers connect with top companies through
